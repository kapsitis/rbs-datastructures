...
if [%2] == [] (
    ...
    if [%2] == [solutions] (
        ...
        python replace.py
	    cd _build\latex
	    xelatex ds-worksheet-week08
        ren ds-worksheet-week08.pdf ds-worksheet-week08-solutions.pdf
        xcopy ds-worksheet-week08-solutions.pdf ..\.. /Y
		cd ..\..
    ) else (
        ...
        xcopy ds-worksheet-week08.pdf ..\.. /Y
		cd ..\..		
	)
)
goto end
