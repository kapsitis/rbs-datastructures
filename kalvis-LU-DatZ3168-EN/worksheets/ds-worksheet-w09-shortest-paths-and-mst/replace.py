...
import re
with open ('_build/latex/ds-worksheet-shortest-paths-and-mst.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open ('_build/latex/ds-worksheet-shortest-paths-and-mst.tex', 'w', encoding='utf-8') as fout:
