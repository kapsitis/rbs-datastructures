...
import re
with open ('_build\\latex\\ds-2022-spring-midterm-var2.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open ('_build\\latex\\ds-2022-spring-midterm-var2.tex', 'w', encoding='utf-8') as fout:
