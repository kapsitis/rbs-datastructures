...
import re
with open ('_build/latex/ds-worksheet-priority-queues.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open ('_build/latex/ds-worksheet-priority-queues.tex', 'w', encoding='utf-8') as fout:
