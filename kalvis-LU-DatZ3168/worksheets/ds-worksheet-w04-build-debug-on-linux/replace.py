...
import re
with open ('_build/latex/ds-worksheet-build-debug-on-linux.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open ('_build/latex/ds-worksheet-build-debug-on-linux.tex', 'w', encoding='utf-8') as fout:
