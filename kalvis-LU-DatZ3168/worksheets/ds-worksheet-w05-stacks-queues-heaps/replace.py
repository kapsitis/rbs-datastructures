...
import re
with open ('_build/latex/ds-worksheet-trees-and-heaps.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open ('_build/latex/ds-worksheet-trees-and-heaps.tex', 'w', encoding='utf-8') as fout:
