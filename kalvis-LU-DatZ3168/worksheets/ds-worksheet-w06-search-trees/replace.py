...
import re
with open ('_build/latex/ds-worksheet-search-trees.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open ('_build/latex/ds-worksheet-search-trees.tex', 'w', encoding='utf-8') as fout:
