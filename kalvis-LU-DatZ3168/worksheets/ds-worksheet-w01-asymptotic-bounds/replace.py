...
import re
with open ('_build/latex/ds-worksheet-asymptotic-bounds.tex', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open ('_build/latex/dds-worksheet-asymptotic-bounds.tex', 'w', encoding='utf-8') as fout:
